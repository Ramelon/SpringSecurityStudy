 ...
 * @description:
 * @author: xzy
 * @time: 2023/11/27 9:58
 */
@Service
public class RamelonOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public RamelonOAuth2UserService(IUserBindThirdLoginService bindThirdLoginService, IUserService userService) {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (!StringUtils.hasText(userRequest.getClientRegistration().getProviderDetails().getUserInfoEndpoint().getUri())) {
            ...
            if (!StringUtils.hasText(userIdAttributeName)) {
                ...
                // 8. 返回UserDetails类型用户
                return new RamelonUserDetails(user.getUserId(), thirdUserId, user.getUserName(),null, user.getPhone(), authorityList,
